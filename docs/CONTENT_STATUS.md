# Portugal con Perro — Estado editorial
...
El contenido que más valor aporta no es una lista de “sitios bonitos”, sino información que cambia una decisión real:

- si el perro puede entrar o no;
- qué condiciones debe cumplir;
- fechas exactas de temporada balnear;
- rutas con distancia y dificultad;
...
- `allowed`: fuente fiable confirma acceso;
- `restricted`: acceso confirmado con condiciones;
...
- casa/villa + perro;
- piscina + perro;
- dos o más perros, si el proveedor suministra ese dato;
- destino + atributos confirmados.
