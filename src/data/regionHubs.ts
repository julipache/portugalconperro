...
export const regionHubs: Record<string, RegionHub> = {
  algarve: {
    slug: 'algarve',
    intro:
      'El Algarve no debería tratarse como un único destino. Para un viaje con perro importa mucho dónde te alojas: el oeste concentra acantilados, rutas y una costa más expuesta; la zona central reúne algunos de los núcleos turísticos más conocidos; y hacia el este el paisaje cambia con la Ria Formosa y sus islas. Esta división es editorial —no administrativa— y sirve para elegir base antes de que conectemos el inventario real de alojamientos.',
    reviewedAt: '2026-09-07',
    areas: [
      {
        name: 'Algarve occidental',
        kicker: 'Costa, acantilados y senderismo',
        summary: 'Nuestra zona prioritaria para empezar: combina Lagos, Sagres, Vila do Bispo y Aljezur con la costa más ligada a rutas como Rota Vicentina y con acceso rápido a zonas interiores.',
      ...
      },
      {
        ...
        summary: 'Incluye grandes bases vacacionales como Portimão, Lagoa/Carvoeiro, Albufeira y el eje de Loulé, Quarteira y Vilamoura.',
        places: ['Portimão', 'Carvoeiro', 'Albufeira', 'Vilamoura y Quarteira'],
        dogLens: 'Aquí la futura API de alojamientos será especialmente importante: no vamos a asumir que una localidad es “mejor con perro” por tener más oferta turística. Compararemos inventario real, vallado, tipo de alojamiento y reglas locales cuando dispongamos de los datos.'
      },
      {
        name: 'Algarve oriental',
        kicker: 'Ria Formosa, islas y ciudades históricas',
        summary: 'Faro, Olhão, Tavira y Vila Real de Santo António forman el tramo oriental. El paisaje se diferencia claramente por la Ria Formosa, sus canales, marismas, islas y playas de barrera.',
        places: ['Faro', 'Olhão', 'Tavira', 'Vila Real de Santo António'],
        dogLens: 'La presencia de espacios protegidos y accesos en barco obliga a revisar cada visita por separado. No vamos a presentar una isla, playa o embarcación como compatible con perros sin una fuente específica.'
      }
    ],
    decisions: [
      {
        title: 'Quiero hacer muchas rutas',
        summary: 'Empezaría mirando el oeste y comparando Lagos, Sagres y Aljezur. Ya tenemos una guía verificada de Lagos y la Rota Vicentina ofrece información específica para caminar con perro.'
      },
      {
        title: 'Quiero una casa con jardín o piscina',
        summary: 'No escogeremos zona por intuición. Cuando llegue Interhome, compararemos cuántos alojamientos reales cumplen mascotas + vallado + tipo de casa + piscina y utilizaremos ese inventario para orientar la elección.'
      },
      {
        title: 'Voy en pleno verano',
        summary: 'La temporada balnear cambia las opciones de arenal con perro. Las fechas y normas deben comprobarse municipio a municipio y playa a playa; por eso nuestras guías locales tendrán más valor que una afirmación genérica sobre “playas dog-friendly en Algarve”.'
      },
      {
    ...
    routeNotes: [
      ...
      },
      {
        ...
        summary: 'La Autoridade Marítima Nacional indica que fuera de la época balnear, o durante ella fuera de áreas concesionadas y debidamente señalizadas, no existe una prohibición legal general de animales. Aun así, edital, señalización y zonas autorizadas son la referencia; nuestras guías locales verificarán cada municipio.',
